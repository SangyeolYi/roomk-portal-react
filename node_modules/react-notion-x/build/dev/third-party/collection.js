...
var Search = ({ block, search, title = "Search" }) => {
  ...
  const [isSearchOpen, setIsSearchOpen] = React33.useState(isShowingSearch);
  React33.useEffect(() => {
...
var CollectionGroup = (_a) => {
  ...
  if (hidden)
    return null;
  return /* @__PURE__ */ React45.createElement("details", __spreadValues({
    open: true,
    className: "notion-collection-group"
  }, detailsProps), /* @__PURE__ */ React45.createElement("summary", __spreadValues({
    className: "notion-collection-group-title"
  }, summaryProps), /* @__PURE__ */ React45.createElement("div", null, /* @__PURE__ */ React45.createElement(Property, {
    schema,
    data: [[value]],
    collection
  }), /* @__PURE__ */ React45.createElement("span", {
    className: "notion-board-th-count"
  }, collectionGroup == null ? void 0 : collectionGroup.total))), /* @__PURE__ */ React45.createElement(CollectionViewComponent, __spreadValues({
    collection,
    collectionGroup
  }, rest)));
};
...
var CollectionViewTable = ({
  ...
  if (isGroupedCollection) {
    ...
    return collectionGroups.map((group, index) => /* @__PURE__ */ React46.createElement(CollectionGroup, __spreadProps(__spreadValues({
      key: index
    }, group), {
      collectionViewComponent: (props) => /* @__PURE__ */ React46.createElement(Table, __spreadProps(__spreadValues({}, props), {
        padding,
        width
      })),
      summaryProps: {
  ...
  return /* @__PURE__ */ React46.createElement(Table, {
    blockIds,
    collection,
    collectionView,
    padding,
...
function Table({ blockIds = [], collection, collectionView, width, padding }) {
  ...
  const tableStyle = React46.useMemo(() => ({
    width,
    maxWidth: width
  }), [width]);
  const tableViewStyle = React46.useMemo(() => ({
    paddingLeft: padding,
    paddingRight: padding
  }), [padding]);
  let properties = [];
  ...
  }, !!properties.length && /* @__PURE__ */ React46.createElement(React46.Fragment, null, /* @__PURE__ */ React46.createElement("div", {
  ...
  }, blockIds == null ? void 0 : blockIds.map((blockId) => /* @__PURE__ */ React46.createElement("div", {
...
var CollectionCard = (_a) => {
  ...
  if ((cover == null ? void 0 : cover.type) === "page_content") {
    ...
    if (contentBlockId) {
      ...
      if (source) {
        ...
        coverContent = /* @__PURE__ */ React47.createElement(LazyImage, {
          src,
    ...
    if (!coverContent) {
      coverContent = /* @__PURE__ */ React47.createElement("div", {
    ...
    if (schema && data) {
      if (schema.type === "file") {
        ...
        const file = files[0];
        if (file) {
          coverContent = /* @__PURE__ */ React47.createElement("span", {
            className: `notion-property-${schema.type}`
          }, /* @__PURE__ */ React47.createElement(LazyImage, {
            alt: file[0],
            src: mapImageUrl(file[2], block),
            style: {
              objectFit: coverAspect,
        ...
        coverContent = /* @__PURE__ */ React47.createElement(Property, {
          propertyId: property,
          schema,
          data
        });
  ...
  const innerCard = /* @__PURE__ */ React47.createElement(React47.Fragment, null, (coverContent || (cover == null ? void 0 : cover.type) !== "none") && /* @__PURE__ */ React47.createElement("div", {
  ...
  return /* @__PURE__ */ React47.createElement(NotionContextProvider, __spreadProps(__spreadValues({}, ctx2), {
    components: __spreadProps(__spreadValues({}, ctx2.components), {
      Link: (props) => {
        var _a3, _b3, _c2;
        return /* @__PURE__ */ React47.createElement("form", {
          action: props.href,
          target: "_blank"
        }, /* @__PURE__ */ React47.createElement("input", {
          type: "submit",
  ...
  }), isLinkCollectionToUrlProperty && url ? /* @__PURE__ */ React47.createElement(components.Link, __spreadValues({
    className: cs("notion-collection-card", `notion-collection-card-size-${coverSize}`, className),
    href: url
  }, rest), innerCard) : /* @__PURE__ */ React47.createElement(components.PageLink, __spreadValues({
    className: cs("notion-collection-card", `notion-collection-card-size-${coverSize}`, className),
    href: mapPageUrl(block.id)
  }, rest), innerCard));
};
...
var CollectionViewGallery = ({
  ...
  return /* @__PURE__ */ React48.createElement(Gallery, {
    collectionView,
    collection,
    blockIds
  });
...
var CollectionViewList = ({
  ...
  if (isGroupedCollection) {
    const collectionGroups = getCollectionGroups(collection, collectionView, collectionData);
    return collectionGroups.map((group, key) => /* @__PURE__ */ React49.createElement(CollectionGroup, __spreadProps(__spreadValues({
      key
    }, group), {
  ...
  return /* @__PURE__ */ React49.createElement(List, {
    blockIds,
    collection,
    collectionView
  });
...
function List({ blockIds, collection, collectionView }) {
  ...
  return /* @__PURE__ */ React49.createElement("div", {
    ...
    return /* @__PURE__ */ React49.createElement(components.PageLink, {
      className: "notion-list-item notion-page-link",
      href: mapPageUrl(block.id),
      key: blockId
    }, /* @__PURE__ */ React49.createElement("div", {
      className: "notion-list-item-title"
    }, /* @__PURE__ */ React49.createElement(Property, {
      schema: titleSchema,
      data: titleData,
      block,
      collection
...
var EmptyIcon = (props) => {
  const _a = props, { className } = _a, rest = __objRest(_a, ["className"]);
  return /* @__PURE__ */ React50.createElement("svg", __spreadProps(__spreadValues({
    className
  }, rest), {
    viewBox: "0 0 14 14",
    width: "14"
...
var CollectionViewBoard = ({
  ...
  if (isGroupedCollection) {
    ...
    return collectionGroups.map((group, index) => /* @__PURE__ */ React51.createElement(CollectionGroup, __spreadProps(__spreadValues({
      ...
      collectionViewComponent: (props) => /* @__PURE__ */ React51.createElement(Board, __spreadValues({
        padding
      }, props))
    })));
  }
  return /* @__PURE__ */ React51.createElement(Board, {
    padding,
    collectionView,
    collection,
    collectionData
...
function Board({ collectionView, collectionData, collection, padding }) {
  ...
  const boardStyle = React51.useMemo(() => ({
    paddingLeft: padding
  }), [padding]);
  return /* @__PURE__ */ React51.createElement("div", {
    ...
    }, ((_b2 = group.value) == null ? void 0 : _b2.value) ? /* @__PURE__ */ React51.createElement(Property, {
      schema,
      data: [[(_c = group.value) == null ? void 0 : _c.value]],
      collection
    }) : /* @__PURE__ */ React51.createElement("span", null, /* @__PURE__ */ React51.createElement(EmptyIcon, {
      className: "notion-board-th-empty"
    }), " No Select"), /* @__PURE__ */ React51.createElement("span", {
      className: "notion-board-th-count"
    }, group.total)));
  }))), /* @__PURE__ */ React51.createElement("div", {
...
var CollectionViewBlock = ({ block, className }) => {
  ...
  const onChangeView = React53.useCallback((collectionViewId2) => {
